...
{
    public class CompareMaxNoDesc : IComparer
    {
        private int _ix;
        private int _iy;
        ...
        public CompareMaxNoDesc() { }
        public CompareMaxNoDesc(int[][] theArray)
        {
            sortArray = theArray;
        }
    /// <summary>
    /// Compare two Max values in jagged array in different rows
    /// </summary>
