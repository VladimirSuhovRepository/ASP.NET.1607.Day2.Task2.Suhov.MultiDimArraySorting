...
{
    public class CompareSumNoDesc : IComparer
    {
        private int _ix;
        private int _iy;
        ...
        public CompareSumNoDesc() { }
        public CompareSumNoDesc(int[][] theArray)
        {
            sortArray = theArray;
        }
    /// <summary>
    /// Compare two Sum values in jagged array in different rows
    /// </summary>
